...
putexcel set "$dir_results/reg_income", sheet("Info") modify //replace
...
merge m:1 stm using "$dir_external_data/wage_growth_rates", keep(3) nogen ///
...
process_regression, domain("income") process("I1a") sheet("I1a_orig") ///
...
logit receives_ypncp ///
	  ...
	  yEmpPersGrossMonthL2 yCapitalPersMonthL2  ///
	  eduSampleFlag_Male ///
...
process_regression, domain("income") process("I1b") sheet("I1b_orig") ///
...
process_regression, domain("income") process("I2b") sheet("I2b_orig") ///
...
process_regression, domain("income") process("I3a") sheet("I3a_orig") ///
...
process_regression, domain("income") process("I3b") sheet("I3b_orig") ///
